...
async function sendBetaWelcome(email: string, name?: string) {
  ...
  const text = [
    ...
    "",
    "As a beta tester you get early access to the Plistic Media Directory before it opens to the public. Add your business (or claim it, if we've already listed you) and customise your page — logo, photos, showreel, packages and prices — to be one of the first businesses on there.",
    "",
    "There's also a brand-new marketplace to explore. Businesses can sell products and services, take bookings, and send buyers a one-off custom offer for bespoke work. You can even take payment in stages — a deposit up front, then the rest released as you finish each part of the job. Buyers pay securely, all the way through to delivery.",
    "",
    ...
    "2) To build your business listing — or to buy or sell — you'll create your own free account, with your own email and password. It's a separate, quick step once you're inside. It works the same whether you're adding a brand-new business or claiming one we've already listed.",
    "",
    ...
    "",
    "Spotted a bug or have feedback? We'd genuinely love to hear it — every note helps us make it better before launch. Three easy ways:",
    `- Share it here: ${siteUrl()}/feedback`,
    "- Use the feedback button in the bottom corner of any page",
