...
async function sendBetaWelcome(email: string, name?: string) {
  ...
  const text = [
    ...
    "2) To actually claim your business and build your listing (and to buy or sell), you'll create your own free account — your own email and password. That's a separate, quick step once you're inside. The shared password on its own does NOT create your listing.",
    "",
