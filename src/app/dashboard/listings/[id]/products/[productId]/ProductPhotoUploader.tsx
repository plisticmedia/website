...
import { uploadProductPhotos } from "../../../products-actions";
import { compressPhoto } from "@/lib/compressImage";
import styles from "../../../Listings.module.css";

/** Photo upload for a marketplace item: several at once, resized in-browser,
 *  with problems shown inline instead of crashing. */
export function ProductPhotoUploader({ serviceId, productId }: { serviceId: string; productId: string }) {
  ...
  async function submit() {
    ...
    try {
      ...
      const res = await uploadProductPhotos(serviceId, productId, fd);
